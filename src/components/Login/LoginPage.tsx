...
export default class LoginPage extends React.Component{
    ...
    render(){
            ...
            <div className="flex-1 h-full max-w-4xl mx-auto bg-white rounded-lg shadow-xl">
                <div className="flex flex-col md:flex-row">
                    <div className="h-32 md:h-auto md:w-1/2">
                        <img className="object-cover w-full h-full" src="https://res.cloudinary.com/canonical/image/fetch/f_auto,q_auto,fl_sanitize,w_645,h_645/https://dashboard.snapcraft.io/site_media/appmedia/2019/11/puploc_feat.png"
                            alt="img" />
                    </div>
        ...
        <div className="mb-4">
        <input type="button" style={{cursor:"pointer"}} className="w-full bg-blue-200 hover:bg-blue-300 text-white font-bold py-2 px-4 border border-blue-300 rounded" value={"Login"}></input>
        </div>
